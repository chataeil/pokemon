...
//        python predict.py "[[ 1.23151481,  0.88790998,  1.6140196,   0.94127238,  1.6784415,   1.38504672, -1.57161094, -0.65513703,  0.99961796 , -0.80484811]]"
       // ProcessBuilder builder = new ProcessBuilder("python predict.py [[ 1.23151481,  0.88790998,  1.6140196,   0.94127238,  1.6784415,   1.38504672, -1.57161094, -0.65513703,  0.99961796 , -0.80484811]]", "D:/recommend/predict.py", "http://localhost:3000/api/dl/data");
        ProcessBuilder builder = new ProcessBuilder("C:\\Users\\admin\\AppData\\Local\\Programs\\Python\\Python39\\python.exe", "predict.py", "[[ 1.23151481,  0.88790998,  1.6140196,   0.94127238,  1.6784415,   1.38504672, -1.57161094, -0.65513703,  0.99961796 , -0.80484811]]");
        Process process = builder.start();
        BufferedReader reader = process.inputReader();
        reader.lines().forEach(System.out::println);
        //int exitCode = process.waitFor();
    ...
    void test3() {
        ...
        int[] item = {123151481, 88790998, 1140196, 94127238, 16784415, 138504672, -157161094, -65513703, 99961796, -80484811};
